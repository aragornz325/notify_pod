...
import 'package:notify_pod_server/src/generated/enums/devices_type.dart' as _i4;
import 'package:notify_pod_server/src/generated/protocol.dart';
import 'package:notify_pod_server/src/generated/endpoints.dart';
...
class _EmailpodEndpoint {
  ...
  _i3.Future<bool> confirmEmailRead(
    _i1.TestSessionBuilder sessionBuilder,
    String slugToken,
    String secretKey,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'emailpod',
        method: 'confirmEmailRead',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'emailpod',
          methodName: 'confirmEmailRead',
          parameters: _i1.testObjectToJson({
            'slugToken': slugToken,
            'secretKey': secretKey,
          }),
